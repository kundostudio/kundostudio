		...
		<Page className="grid grid-cols-4 md:grid-cols-8 lg:grid-cols-12 gap-x-4 gap-y-8 md:gap-x-6 lg:gap-x-8 pb-[120px]">
			...
			<div className="col-span-full flex flex-col mt-10 md:mt-18 lg:translate-y-6 lg:mt-28">
				...
				<div className="relative inline-block w-fit">
					<Typography.H1 className="leading-none w-fit mt-1 mb-8">
						{worksData?.title || "Projects"}
					</Typography.H1>
				...
				<Typography.P className="text-secondary uppercase max-w-[250px]">
					...
					{worksData?.subtitle || "EXPLORE THE WORK WE DID WITH AMAZING CLIENTS."}
				</Typography.P>
			</div>
			...
			<div className="text-start col-span-4 md:col-start-4 md:col-span-5 lg:col-start-5 lg:col-span-6">
				{worksData?.description ? (
					<PortableText value={worksData.description} />
				) : (
					<Typography.H3>
						We build relationships that continue to deliver value long after a project ends. Below
						is a selection of projects from diverse industries, showcasing the unique partnerships
						and impactful results we&apos;ve created together.
					</Typography.H3>
				)}
			</div>
