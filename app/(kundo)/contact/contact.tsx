	...
	return (
		<Page className="grid grid-cols-4 md:grid-cols-8 lg:grid-cols-12 gap-x-4 gap-y-8 md:gap-x-6 lg:gap-x-8 pb-[120px]">
			...
			<div className="col-span-full flex flex-col mt-10 md:mt-18 lg:translate-y-6 lg:mt-28">
				<Typography.H1 className="text-secondary uppercase">/ CONTACT</Typography.H1>
				...
				<Typography.P className="text-secondary uppercase">
					<span className="text-primary">LET&apos;S WORK TOGETHER.</span> REACH OUT TO START A
					CONVERSATION.
				</Typography.P>
			</div>
			...
			<div className="flex flex-col gap-8 col-span-4 md:col-start-4 md:col-span-5 lg:col-start-5 lg:col-span-6 md:pb-8">
				{contactData?.contactContent ? (
					...
					<Typography.P>
						No contact content available. Add content in the Sanity Studio.
					</Typography.P>
				)}
			...
			<div className="flex flex-col gap-8 col-span-4 md:col-start-4 md:col-span-5 lg:col-start-5 lg:col-span-6 md:pb-8">
				{contactData?.collaborateContent ? (
					...
					<Typography.P>
						No collaborate content available. Add content in the Sanity Studio.
					</Typography.P>
				)}
			...
			<div className="flex flex-col gap-8 col-span-4 md:col-start-4 md:col-span-5 lg:col-start-5 lg:col-span-6 md:pb-8">
				{contactData?.followContent ? (
					...
					<Typography.P>
						No follow content available. Add content in the Sanity Studio.
					</Typography.P>
				)}
